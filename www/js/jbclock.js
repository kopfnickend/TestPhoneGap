...
function JBCountDown(settings) {
    ...
    function hideClocks() {
    	if($(".clock_days .val").text() == 0){
        	$('.clock_days').css({ "display": "none"});
        	$('.clock').css({ "width": "400px"});
        	
        	if($(".clock_hours .val").text() == 0){
        		$('.clock_hours').css({ "display": "none"});
        		$('.clock').css({ "width": "260px"});
        		
        		if($(".clock_minutes .val").text() == 0){
        			$('.clock_minutes').css({ "display": "none"});
        			$('.clock').css({ "width": "130px"});
        		}
        	}
        } 
